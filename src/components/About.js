  ...
  return (
    <div id="about" className="relative bg-black  px-4 lg:pl-20 lg:pr-10 py-20 lg:py-40 lg:flex gap-10 text-white seasons border-b border-white/50">
      ...
      <div className="grid lg:grid-cols-2 gap-x-10 gap-y-8 lg:gap-y-12">
        ...
        <div className="">
          <h3 className="text-lg font-bold font-montserrat">Philanthropist</h3>
          <p className=" leading-[1.5rem] mt-5">
        ...
        <div className="">
          <h3 className="text-lg font-bold font-montserrat">Entrepreneur</h3>
          <p className=" leading-[1.5rem] mt-5">
        ...
        <div className="">
          <h3 className="text-lg font-bold font-montserrat">Multitalented Individual</h3>
          <p className=" leading-[1.5rem] mt-5">
